Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/cweymann/OHHTTPStubs"
  s.license      = "MIT"
  s.authors      = { 'Olivier Halligon' => 'olivier.halligon+ae@gmail.com' }

  s.source       = { :git => "https://github.com/cweymann/OHHTTPStubs.git", :tag => s.version.to_s }
  ...
  s.subspec 'Default' do |default|
    default.dependency 'AVMHTTPStubs/Core'
    default.dependency 'AVMHTTPStubs/NSURLSession'
    default.dependency 'AVMHTTPStubs/JSON'
    default.dependency 'AVMHTTPStubs/OHPathHelpers'
  end
  ...
  s.subspec 'NSURLSession' do |urlsession|
    urlsession.dependency 'AVMHTTPStubs/Core'
